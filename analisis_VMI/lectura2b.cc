...
int lectura2b(char *archivo){
	...
	funcins->SetParameters(peaksYins[0],peaksins[0],sigmains*2);
	funcins->SetParLimits(0,0,20000);
	funcins->SetParLimits(1,peaksins[0]-sigmains,peaksins[0]+sigmains);
	...
	func2ins->SetParLimits(0,0,2000);
	...
	TSpectrum *specesp= new TSpectrum(10);	
	 //finding Spectra Peaks
	Int_t npeaksesp = specesp->Search(h1esp,0.1,"",0.005); // Al objeto de clase TSpectrum le hago buscar peaks en el histograma apuntado por el puntero h
	//Finding peaks and fitting gaussians
	...
	func3ins->SetParameters(peaksY2ins[0],peaks2ins[0],sigma2ins*2);
	...
	func3esp->SetParameters(peaksY2esp[0],peaks2esp[0],sigma2esp);
	...
	TSpectrum *spec3ins = new TSpectrum(10);	
	 //finding Spectra Peaks
	Int_t npeaks3ins = spec3ins->Search(h3ins,0.8,"",0.005); // Al objeto de clase TSpectrum le hago buscar peaks en el histograma apuntado por el puntero h
	//Finding peaks and fitting gaussians
	...
	func5esp->SetParameters(peaksY3esp[0],peaks3esp[0],sigma3esp*2);
	...
	TSpectrum *spec5esp= new TSpectrum(10);	
	 //finding Spectra Peaks
