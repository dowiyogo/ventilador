...
int lectura4(char *archivo){
    ...
    adc->Draw("sf1old>>hist1ins(1000,-10,50)","vt<610&&vt>560"); 
	TH1F* h1ins;
    ...
    adc->Draw("sf2old>>hist1esp(1000,-10,50)","vt<610&&vt>560"); 
	TH1F* h1esp;
	...
	adc->Draw("sf1old>>hist2ins(1000,-10,50)","vt<510&&vt>480"); 
	TH1F* h2ins;
	...
	adc->Draw("sf2old>>hist2esp(1000,-10,50)","vt<510&&vt>480"); 
	TH1F* h2esp;
	...
	canvas1->cd(5);
	adc->Draw("sf1old>>hist3ins(1000,-10,50)","vt<420&&vt>390"); 
	TH1F* h3ins;
	...
	//canvas3->cd(2);
    canvas1->cd(6);
	adc->Draw("sf2old>>hist3esp(1000,-10,50)","vt<420&&vt>390"); 
	TH1F* h3esp;
	...
	//canvas4->cd(1);
	canvas1->cd(7);
	adc->Draw("sf1old>>hist4ins(1000,-10,50)","vt<310&&vt>280"); 
	TH1F* h4ins;
	...
	adc->Draw("sf2old>>hist4esp(1000,-10,50)","vt<310&&vt>280"); 
	TH1F* h4esp;
	...
	//canvas5->cd(1);
	canvas1->cd(9);
	adc->Draw("sf1old>>hist5ins(1000,-10,50)","vt<210&&vt>190"); 
	TH1F* h5ins;
	...
	adc->Draw("sf2old>>hist5esp(1000,-10,50)","vt<210&&vt>190"); 
	TH1F* h5esp;
   ...
   //Access the fit resuts
	...
	canvas1c->cd(3);
	adc->Draw(Form("sf1old - %f>>hist2cins(1000,-10,50)",scaleIns),"vt<510&&vt>480"); 
	TH1F* h2cins;
	...
	canvas1c->cd(5);
	adc->Draw(Form("sf1old - %f>>hist3cins(1000,-10,50)",scaleIns),"vt<420&&vt>390"); 
	TH1F* h3cins;
	...
	canvas1c->cd(7);
	adc->Draw(Form("sf1old - %f>>hist4cins(1000,-10,50)",scaleIns),"vt<310&&vt>280"); 
	TH1F* h4cins;
	...
	canvas1c->cd(9);
	adc->Draw(Form("sf1old - %f>>hist5cins(1000,-10,50)",scaleIns),"vt<210&&vt>190"); 
	TH1F* h5cins;
   ...
   //Access the fit resuts
	...
	canvas1c->cd(2);
	adc->Draw(Form("sf2old - %f>>hist1cesp(1000,-10,50)",scaleEsp),"vt<610&&vt>580"); 
	TH1F* h1cesp;
	...
	canvas1c->cd(4);
	adc->Draw(Form("sf2old - %f>>hist2cesp(1000,-10,50)",scaleEsp),"vt<510&&vt>480"); 
	TH1F* h2cesp;
	...
	canvas1c->cd(6);
	adc->Draw(Form("sf2old - %f>>hist3cesp(1000,-10,50)",scaleEsp),"vt<420&&vt>390"); 
	TH1F* h3cesp;
	...
	canvas1c->cd(8);
	adc->Draw(Form("sf2old - %f>>hist4cesp(1000,-10,50)",scaleEsp),"vt<310&&vt>280"); 
	TH1F* h4cesp;
	...
	canvas1c->cd(10);
	adc->Draw(Form("sf2old - %f>>hist5cesp(1000,-10,50)",scaleEsp),"vt<210&&vt>190"); 
	TH1F* h5cesp;
