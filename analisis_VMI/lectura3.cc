...
int lectura3(char *archivo){
	...
	TCanvas *canvasnuevo = new TCanvas("canvasnuevo","Histogramas");

	adc->Draw("sf1f>>histnuevo(1000,-10,50)","vt<610&&vt>580"); 
	TH1F* hnuevo;
	hnuevo = (TH1F *)gROOT->FindObject("histnuevo"); // Busco el objeto y asigno un puntero para el histograma recien dibujado
